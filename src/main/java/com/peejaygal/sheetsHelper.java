...
class sheetsHelper{
    private static final String excelFilePath = "C:\\Users\\pjgal\\Desktop\\sample.xlsx";

    public static void appendValue(String cellValue, String sheetName, String timeStamp) throws IOException {
    ...
    public static boolean isExisting(String cellValue, String sheetName) throws IOException {
        FileInputStream inputStream = new FileInputStream(new File(excelFilePath));
        Workbook workbook = new XSSFWorkbook(inputStream);
        Sheet firstSheet = null;
        if (workbook.getSheet(sheetName) == null){
